...
train_data_dir = 'coat_length/data/train'
validation_data_dir = 'coat_length/data/validation'
...
model = DenseNet(reduction=0.5, classes=1000, weights_path=weights_path, category_num=8)
# x = model.output
...
model.save_weights('models/densenet121_coat.h5')
